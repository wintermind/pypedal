...
{\em An} & instance of a Pedigree() object populated with data. \begin{DoxyVerb}
...
Definition at line 3017 of file pyp\_\-newclasses.py.
...
Definition at line 3117 of file pyp\_\-newclasses.py.
...
\begin{DoxyRetVals}{Return values}
{\em The} & number of unique dams in the pedigree and a list of those dams \begin{DoxyVerb}
...
Definition at line 3160 of file pyp\_\-newclasses.py.
...
\begin{DoxyRetVals}{Return values}
{\em The} & number of unique founders in the pedigree and a list of those founders \begin{DoxyVerb}
...
Definition at line 3199 of file pyp\_\-newclasses.py.
...
\begin{DoxyRetVals}{Return values}
{\em The} & number of unique generations in the pedigree and a list of those generations \begin{DoxyVerb}
...
Definition at line 3172 of file pyp\_\-newclasses.py.
...
\begin{DoxyRetVals}{Return values}
{\em The} & number of unique herds in the pedigree and a list of those herds \begin{DoxyVerb}
...
Definition at line 3215 of file pyp\_\-newclasses.py.
...
\begin{DoxyRetVals}{Return values}
{\em The} & number of unique sires in the pedigree and a list of those sires \begin{DoxyVerb}
...
Definition at line 3148 of file pyp\_\-newclasses.py.
...
\begin{DoxyRetVals}{Return values}
{\em The} & number of unique birthyears in the pedigree and a list of those birthyears \begin{DoxyVerb}
...
Definition at line 3187 of file pyp\_\-newclasses.py.
...
Definition at line 3067 of file pyp\_\-newclasses.py.
...
\begin{DoxyRetVals}{Return values}
{\em A} & summary of the metadata stored in the pedigree as a string. \begin{DoxyVerb}
...
Definition at line 3098 of file pyp\_\-newclasses.py.
