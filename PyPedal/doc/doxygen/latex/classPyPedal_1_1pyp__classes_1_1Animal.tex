...
\begin{DoxyVerb}A simple class to hold animals records read from a pedigree file.\end{DoxyVerb}
...
{\em self} & Reference to the current Animal() object \\
\hline
{\em animalID} & \hyperlink{classPyPedal_1_1pyp__classes_1_1Animal}{Animal} ID number \\
\hline
{\em sireID} & Sire ID number \\
\hline
{\em damID} & Dam ID number \\
\hline
{\em gen} & Generation to which the animal belongs \\
\hline
{\em by} & Birthyear of the animal \\
\hline
{\em sex} & Sex of the animal (m$|$f$|$u) \\
\hline
{\em fa} & Coefficient of inbreeding of the animal \\
\hline
{\em name} & Name of animal \\
\hline
{\em alleles} & A two-\/element array of strings, which represent allelotypes. \\
\hline
{\em breed} & Breed of animal \\
\hline
{\em age} & Age of animal \\
\hline
{\em alive} & Status of animal (alive or dead) \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em self} & Reference to the current Animal() object \begin{DoxyVerb}Print the contents of an animal record - used for debugging.\end{DoxyVerb}
 \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em self} & Reference to the current Animal() object \begin{DoxyVerb}Return the contents of an animal record as a string.\end{DoxyVerb}
 \\
\hline
\end{DoxyParams}
