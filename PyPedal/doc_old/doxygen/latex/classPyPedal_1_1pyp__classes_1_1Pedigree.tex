...
\item[{\em self}]Reference to the current Pedigree() object \item[{\em myped}]A PyPedal pedigree \item[{\em inputfile}]The name of the file from which the pedigree was loaded \item[{\em name}]The name assigned to the PyPedal pedigree \item[{\em pedcode}]The format code for the PyPedal pedigree \item[{\em reord}]Flag indicating whether or not the pedigree is reordered (0$|$1) \item[{\em renum}]Flag indicating whether or not the pedigree is renumbered (0$|$1) \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em self}]Reference to the current Pedigree() object \begin{DoxyVerb}Save the pedigree metadata to a file.\end{DoxyVerb}
 \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em self}]Reference to the current Pedigree() object \begin{DoxyVerb}Print the pedigree metadata.\end{DoxyVerb}
 \end{DoxyParams}
