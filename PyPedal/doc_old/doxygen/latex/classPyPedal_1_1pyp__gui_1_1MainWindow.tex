...
\begin{DoxyCompactList}\small\item\em \char`\"{}File\char`\"{} menu events \item\end{DoxyCompactList}\item 
...
\item[{\em event}]The type of event causing invocation of this method. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em filename}]The pedigree file name. \end{DoxyParams}
\begin{DoxyReturn}{Returns}
None  None 
\end{DoxyReturn}
